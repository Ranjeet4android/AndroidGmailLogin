...
public class MainActivity extends AppCompatActivity
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            Picasso.with(MainActivity.this).load(acct.getPhotoUrl()).into(google_icon);
            mStatusTextView.setText(getString(R.string.signed_in_fmt, acct.getDisplayName()+"\n"+acct.getEmail()));
            tv_profile_name.setText(acct.getDisplayName());
            tv_profile_email.setText(acct.getEmail());
            Picasso.with(MainActivity.this).load(acct.getPhotoUrl()).into(iv_profile_pic);
